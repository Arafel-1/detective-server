const Config = {
    ...
    // URL por defecto (para APK final compilada)
    // Usamos la URL de Render para que funcione sin configuración manual
    defaultUrl: 'https://detective-server.onrender.com',
